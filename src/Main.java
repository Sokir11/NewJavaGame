...
public class Main {
    ...
    private static JPanel createMenuPanel(
        ...
        JButton easyButton =
                new JButton("Easy (Less rocks)");

        JButton mediumButton =
                new JButton("Mid");

        JButton hardButton =
                new JButton("Hard (Many rocks)");
        ...
        easyButton.addActionListener(e -> {
            ...
            // כאן מזמנים את התחלת המשחק ברמת EASY
        ...
        mediumButton.addActionListener(e -> {
            ...
            // כאן מזמנים את התחלת המשחק ברמת MID
            startGameWithDifficulty(
                    cardLayout,
                    mainPanel,
                    gameScene,
        ...
        hardButton.addActionListener(e -> {
            ...
            // כאן מזמנים את התחלת המשחק ברמת HARD
            startGameWithDifficulty(
                    cardLayout,
                    mainPanel,
                    gameScene,
    ...
    private static void startGameWithDifficulty(
            CardLayout cardLayout,
            JPanel mainPanel,
            Scene gameScene,
            int difficultyLevel) {
        ...
        /*
         * שלב 3:
         * כאן מזמנים את תחילת המשחק.
         *
         * startGame() נמצאת במחלקת Scene,
         * והיא זו שמפעילה את mainGameLoop().
         */
        gameScene.startGame();

        /*
         * שלב 4:
         * נותנים ל-Scene לקבל קלט מהמקלדת.
         */
